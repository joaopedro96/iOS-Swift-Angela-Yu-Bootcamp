...
struct StoryBrain {
    ...
    mutating func nextStory(_ userChoice: String) {
        if userChoice == storyData[storyIndex].choice1 {
            storyIndex = storyData[storyIndex].choice1Destination
        } else if userChoice == storyData[storyIndex].choice2 {
            storyIndex = storyData[storyIndex].choice2Destination
        }
    }
    
    func getStoryText() -> String {
        return storyData[storyIndex].title
    }
    
    func getChoice1Text() -> String {
        return storyData[storyIndex].choice1
    }
    
    func getChoice2Text() -> String {
        return storyData[storyIndex].choice2
    }
}
